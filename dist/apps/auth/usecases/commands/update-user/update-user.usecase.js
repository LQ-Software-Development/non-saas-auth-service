...
let UpdateUserUseCase = class UpdateUserUseCase {
    ...
    async update(id, data) {
        ...
        if (!user) {
            return result_1.Result.fail(new exceptions_1.ForbiddenException('User not found'));
        }
        ...
        if (updatedUserOrError.isFailure) {
            return result_1.Result.fail(updatedUserOrError.error);
        }
        return result_1.Result.ok(updatedUserOrError).value;
    }
};
